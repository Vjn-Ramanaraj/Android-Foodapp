...
public class Update extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateDesc, updateName, updateCategory,updatePrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateCategory=findViewById(R.id.updateCat);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("FoodDB").child(String.valueOf(key));
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                saveData();
                Intent intent = new Intent(Update.this, menu.class);
